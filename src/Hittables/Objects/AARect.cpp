...
template <>
DEV AABB AARect<utils::Axis::X>::computeBoundingBox(const double i0, const double i1, const double j0,
...
template <>
DEV AABB AARect<utils::Axis::Y>::computeBoundingBox(const double i0, const double i1, const double j0,
                                                const double j1, const double k) const
{
...
template <>
DEV AABB AARect<utils::Axis::Z>::computeBoundingBox(const double i0, const double i1, const double j0,
                                                const double j1, const double k) const
{
...
template <enum utils::Axis A>
DEV Hittable::HitType AARect<A>::getCollisionData(const Ray &ray, HitRecord &record,
...
template <enum utils::Axis A>
DEV double AARect<A>::eval(const Vec3& origin, const Vec3& v, bool flip) const
{
...
template <>
DEV void AARect<utils::Axis::X>::solveForTime(const Ray &ray, double &t) const
{
    t = (k - ray.getOrigin().x()) / ray.getDirection().x();
}

template <>
DEV void AARect<utils::Axis::Y>::solveForTime(const Ray &ray, double &t) const
{
    t = (k - ray.getOrigin().y()) / ray.getDirection().y();
}

template <>
DEV void AARect<utils::Axis::Z>::solveForTime(const Ray &ray, double &t) const
{
    t = (k - ray.getOrigin().z()) / ray.getDirection().z();
}

template <>
DEV void AARect<utils::Axis::X>::getPlaneIntersection(const Ray &ray, double &i, double &j, const double t) const
{
...
template <>
DEV void AARect<utils::Axis::Y>::getPlaneIntersection(const Ray &ray, double &i, double &j, const double t) const
{
...
template <>
DEV void AARect<utils::Axis::Z>::getPlaneIntersection(const Ray &ray, double &i, double &j, const double t) const
{
    i = ray.getOrigin().x() + ray.getDirection().x() * t;
...
template <>
DEV void AARect<utils::Axis::X>::setHitPoint(const double i, const double j, const double k, Hittable::HitRecord &record) const
{
...
template <>
DEV void AARect<utils::Axis::Y>::setHitPoint(const double i, const double j, const double k, Hittable::HitRecord &record) const
{
...
template <>
DEV void AARect<utils::Axis::Z>::setHitPoint(const double i, const double j, const double k, Hittable::HitRecord &record) const
{
...
template <>
DEV Vec3 AARect<utils::Axis::X>::genRandomVector(const Vec3& origin) const
{
...
template <>
DEV Vec3 AARect<utils::Axis::Y>::genRandomVector(const Vec3& origin) const
{
...
template <>
DEV Vec3 AARect<utils::Axis::Z>::genRandomVector(const Vec3& origin) const
{
