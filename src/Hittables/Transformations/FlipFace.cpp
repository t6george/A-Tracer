...
Hittable::HitType FlipFace::getCollisionData(const Ray &ray, HitRecord &record, WeightedPdf &pdf,
                             double tMin, double tMax, bool flip) const
{
    return hittable->getCollisionData(ray, record, pdf, tMin, tMax, true);
}
